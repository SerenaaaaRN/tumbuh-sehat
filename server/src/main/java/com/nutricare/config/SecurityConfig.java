 ...
 * - Stateless (JWT, bukan session)
 * - CORS untuk Next.js & React Native
 * - @PreAuthorize aktif via @EnableMethodSecurity
 * - Public endpoints: /api/auth/**, /api/verify (publik QR verifikasi)
 */
@Configuration
@EnableWebSecurity
@EnableMethodSecurity  // Aktifkan @PreAuthorize di controller/service
